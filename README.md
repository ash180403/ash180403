...
Feel free to replace `yourusername` with your actual GitHub username and update the numbers for contributions manually or via badges you prefer.

This layout keeps things clean, professional, visually balanced, and informative, just like your reference image.
If you want, I can generate a full README.md file snippet ready to use.
